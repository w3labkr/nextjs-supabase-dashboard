...
export const httpStatusCodes: HttpStatusCode[] = [
  ...
  { status: 306, statusText: "Switch Proxy (Unused)", message: "This response code is no longer used; it is just reserved." },
  ...
  { status: 402, statusText: "Payment Required (Unused)", message: "This response code is reserved for future use." },
  ...
  { status: 418, statusText: "I'm a teapot (Unused)", message: "The server refuses the attempt to brew coffee with a teapot." },
